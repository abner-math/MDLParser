...
public class MDLAnimationKeysTest {
	...
	@Test
	public void test() throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, MDLParserErrorException {
		String s1 = "Alpha 2 {\n\tDontInterp,\n\tGlobalSeqId 0,\n\t0: 10,\n\t100: 50,\n}\n";
		...
		Assert.assertEquals("DontInterp", frames.getInterpolationType());
		...
		frames3.setInterpolationType("Linear");
		String s4 = "Alpha 4 {\n\tLinear,\n\tGlobalSeqId 0,\n\t0: 10,\n\t100: 50,\n\t150: 50,\n\t170: 50,\n}\n";
		Assert.assertEquals(s4, frames3.toMDL());
		frames3.setInterpolationType("Bezier");
		Assert.assertEquals(s3, frames3.toMDL());
